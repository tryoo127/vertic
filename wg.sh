...
# Tambahan
cd /usr/bin
wget -O mwg "https://raw.githubusercontent.com/tryoo127/vertic/main/mwg.sh"
wget -O add-wg "https://raw.githubusercontent.com/tryoo127/vertic/main/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/tryoo127/vertic/main/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/tryoo127/vertic/main/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/tryoo127/vertic/main/renew-wg.sh"
wget -O port-wg "https://raw.githubusercontent.com/tryoo127/vertic/main/port-wg.sh"
chmod +x mwg
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
